...
- Current status: **EXECUTED — 2026-08-17T05:25:34Z to 05:31:51Z, k6 exit code 0, all five thresholds passed, GUI evidence captured**

Execution outcome is recorded in `metadata.json`, `screenshot-manifest.md`, and
`second-run-completion-report.md` inside the evidence directory. The instructions
below are retained as the pre-run record of what was required.
