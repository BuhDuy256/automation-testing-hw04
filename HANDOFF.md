...
The next substantive action is `ACT-GEN-01`: generate AI test candidates for `FR-04 PUT /api/users/me`.

The next session should:

1. read `./HANDOFF.md`;
2. read `work/selection/HW06-A-FR04-PUT-USERS-ME-verified-spec.md`;
3. inspect the ACT-GEN-01 standard;
4. generate the required AI test candidates for `PUT /api/users/me`;
5. preserve auditable AI interaction evidence according to ACT-AI-01.

Do not jump directly to Postman execution.
