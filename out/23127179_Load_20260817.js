...
export const options = {
  ...
  thresholds: {
    ...
    // These latency values are provisional calibration-derived regression guards,
    // not business service-level objectives.
    http_req_duration: ['p(95)<60', 'p(99)<85'],
    iteration_duration: ['p(95)<19000'],
  },
...
export default function () {
  ...
  recordResponse(registerResponse, endpointLatency.register);
  ...
  recordResponse(loginResponse, endpointLatency.login);
  ...
  recordResponse(profileResponse, endpointLatency.readProfile);
  ...
  recordResponse(updateResponse, endpointLatency.updateProfile);
  ...
  recordResponse(categoriesResponse, endpointLatency.readCategories);
  ...
  recordResponse(productsResponse, endpointLatency.readProducts);
  ...
  recordResponse(detailResponse, endpointLatency.readProductDetail);
  ...
  recordResponse(cartResponse, endpointLatency.addToCart);
  ...
  recordResponse(checkoutResponse, endpointLatency.checkout);
