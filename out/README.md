...
> combined. Task 2 and Agent Skill demo video links are recorded in §7.
...
_Per HW04 §15. Self-assessment with the user-provided demo video links recorded in §7._
...
| 2 | Task 2 — Demo video | 15 | **15** | Unlisted YouTube link recorded in §7 |
...
| | **Total** | **100** | **100** | All required deliverable categories are represented in `out/` |
...
| Task 2 demo video | https://youtu.be/4X_cNxSEe8c?si=QXdmFXKcrOrW3e6v |
...
| Implementation plan + architecture | `docs/implementation-plan/` (submitted copy) |

## 7. Demo videos

HW04 Task 2 requires an unlisted YouTube video of at least 5 minutes, narrated in Vietnamese,
showing one automation script running end to end, including the multi-browser run and generated HTML
report, with authorship evidence by face-cam or terminal `whoami` / `hostname`.

| Requirement | Link |
|---|---|
| **Task 2 — automation demo video** | https://youtu.be/4X_cNxSEe8c?si=QXdmFXKcrOrW3e6v |
| **HW04 §7 — Agent Skill demo video** | https://youtu.be/OYRspFcq90g?si=vUab9AZqG7kaPnG7 |

The first link is the Task 2 video. The second link is the Agent Skill demonstration video showing
the submitted `test-automation-design` skill used end to end on a completed feature.
